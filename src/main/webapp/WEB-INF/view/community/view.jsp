...
<div style="padding: 10px;">
 ...
 <!-- 목록버튼 누르면 게시글 목록으로 이동 -->
   <div class="button_box" style="float: right;">
   		<a class="btn btn-light" style="border-color: #FFFF8F; background-color: #FFFF8F;"role="button" href="<c:url value='/community/communityList'></c:url>" >목록</a>
   </div>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="comment-wrapper">
            <div class="panel panel-info">
                ...
                <form name="form" method="POST" action="<c:url value='community/reply/insert' > <c:param name='com_id' value='${community.com_id }'/></c:url>">
                    ...
                    <c:forEach var="reply" items="${replyList}">
                        ...
                        <li class="media">
                            <div class="media-body">
								...
								<div class="button_box" style="float: right;">								
								<a class="btn btn-danger btn-sm" role="button" style="background-color: #FFD1FF; border-color: #FFD1FF;" href="<c:url value='community/reply/delete' >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger" role="button" href="<c:url value='/wish/insert'>
        <c:param name='com_id' value='${community.com_id }'/>
